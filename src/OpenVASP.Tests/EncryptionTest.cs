...
namespace OpenVASP.Tests
{
    public class EncryptionTest
    {
        ...
        public void ExampleTest(string privateKeySecp256k1, string publicKeySecp256k1, string sharedKey)
        {
        ...
        public void TheoryTest(string aliceKeyStr, string bobKeyStr, string expectedSharedStr)
        {
